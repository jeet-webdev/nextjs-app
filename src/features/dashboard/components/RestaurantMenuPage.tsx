...
export default function RestaurantMenuPage({ restaurant, onBack }: RestaurantMenuPageProps) {
        ...
        <section className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/30 backdrop-blur-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold">{restaurantDetails.name}</h1>
              <p className="mt-2 text-sm text-gray-400">
                {restaurantDetails.category} in {restaurantDetails.city}
              </p>
            </div>
